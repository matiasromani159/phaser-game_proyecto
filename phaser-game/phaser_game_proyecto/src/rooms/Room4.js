...
export default class Room4 extends BaseGameScene {
    constructor() {
        super('Room4');
    }
    ...
    create(data) {
        ...
        this._npcHablado = GameState.estaVisto('room4_tenna');
    ...
    getRoomConfig() {
        return {
            ...
            doors: {
                arriba:    null,
                abajo:     null,
                izquierda: { goTo: 'Room3', spawn: { x: 396, y: 162 } },
                derecha:   { goTo: 'Room5', spawn: { x: 36,  y: 162 } },
            }
        };
    }
